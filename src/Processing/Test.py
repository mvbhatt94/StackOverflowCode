...
with open("/media/parvez/IntelSSD/MigrationRecommender/post_index/astronomy.meta.stackexchange.com.ser", "rb") as pickle_file:
    post = pickle.load(file =pickle_file)
    post.print_post()
    post = pickle.load(file=pickle_file)
    post.print_post()
    post = pickle.load(file=pickle_file)
